...
constexpr std::array<Translation, UiTextCount> TextCatalog{{
    ...
    {{"Menu Appearance and Size", "選單外觀與大小", "Menü: Darstellung und Größe", "Apariencia y tamaño del menú", "Apparence et taille du menu", "Aspetto e dimensioni del menu", "메뉴 모양 및 크기", "Wygląd i rozmiar menu", "メニューの外観とサイズ", "Aparência e tamanho do menu", "Внешний вид и размер меню", "菜单外观与大小"}},
    ...
    {{"Interface Scale", "介面縮放", "Oberflächenskalierung", "Escala de la interfaz", "Échelle de l’interface", "Scala dell’interfaccia", "인터페이스 크기", "Skala interfejsu", "インターフェース倍率", "Escala da interface", "Масштаб интерфейса", "界面缩放"}},
    {{"Automatic", "自動", "Automatisch", "Automático", "Automatique", "Automatico", "자동", "Automatycznie", "自動", "Automático", "Автоматически", "自动"}},
